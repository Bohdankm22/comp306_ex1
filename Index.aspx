...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
            <asp:TextBox ID="TextBox4" runat="server" Width="500px" MaxLength="12"></asp:TextBox>
        ...
        <p style="margin-left: 80px">
            ...
            &nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox5" runat="server" Width="500px" MaxLength="15"></asp:TextBox>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox6" runat="server" Height="134px" MaxLength="400" TextMode="MultiLine" Width="500px"></asp:TextBox>
        </p>
        <p style="margin-left: 360px">
